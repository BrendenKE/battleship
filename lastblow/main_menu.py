...
class MainMenu(tk.Frame):
	...
	def __init__(self, parent, Game):
		...
		self.playing = tk.Button(self.main_frame, text="Play", font=("Arial", 18, "bold"), command=lambda:self.game.create_board())
		self.playing.pack(pady=5)

		self.exitbtn = tk.Button(self.main_frame, text="Exit", font=("Arial", 18, "bold"), command=lambda:self.game.exit())
		self.exitbtn.pack(pady=5)